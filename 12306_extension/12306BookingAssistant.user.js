...
// @include      *://www.12306.cn:8880/otswebtest/*
...
withjQuery(function($, window){
	...
	route("loginAction.do?method=init", function() {
		...
		// 测试环境
		var url = "http://www.12306.cn:8880/otswebtest/loginAction.do?method=login";
		var queryurl = "http://www.12306.cn:8880/otswebtest/order/querySingleAction.do?method=init";
		...
		// get the loginRand code - huangmei 2012-1-20
		var getLoginRandUrl = "http://www.12306.cn:8880/otswebtest/loginAction.do?method=loginAysnSuggest";
		$.ajax({
			type: "GET",
			url:  getLoginRandUrl,
			timeout: 30000,
	...
	function submit() {
		...
		// 测试环境
		var userInfoUrl = "http://www.12306.cn:8880/otswebtest/order/myOrderAction.do?method=queryMyOrderNotComplete&leftmenu=Y";
