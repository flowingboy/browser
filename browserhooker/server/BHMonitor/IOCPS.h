...
#define IOCPSERVERVERSION "IOCP Server/Client system modified from the version of Amin Gholiha by Mallory. Copyright (C) 2005 - 2009"
...
private: 
	...
	// Används för att binda all sockets till GetQueuedCompletionStatus
