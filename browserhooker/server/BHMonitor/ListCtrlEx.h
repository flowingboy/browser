...
namespace ListCtrlEx
{
	...
	// for reason that in standard include files, there is no defination of DWORD_PTR although in SDK include
	// files, it has, but if we put the sdk include path before the standard path, it will cause other problems.
