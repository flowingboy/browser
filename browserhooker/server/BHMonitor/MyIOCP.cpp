...
{
	AfxMessageBox((LPCTSTR)pOverlapBuff->GetBuffer(),  MB_OK);
...
// this function call BuildPackageAndSend to do the real work
// we need to feed the sending data in ClientContent::
...
// here we send the data back to clients - flowingboy
